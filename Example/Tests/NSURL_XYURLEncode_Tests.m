...
@interface NSURL_XYURLEncode_Tests : XCTestCase

@end

@implementation NSURL_XYURLEncode_Tests
...
- (void)testEncode {
    ...
    NSURL * encodeURL = [url xy_encode];
    NSString * encodeString = encodeURL.absoluteString;
